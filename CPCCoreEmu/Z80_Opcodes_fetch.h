...
case 0x10: if (t_ == 5) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = pc_; current_data_ = 0; read_count_ = 0; }
           else { ++t_; }break; // DJNZ e
...
case 0x13: if (t_ == 6) { ++de_.w; NEXT_INSTR; }
           else { ++t_; } break;                                                // INC DE
...
case 0x23: if (t_ == 6) { ++hl_.w; NEXT_INSTR; }
...
case 0x27: btmp = af_.b.h; if (af_.b.l & NF) { if ((af_.b.l&HF) | ((af_.b.h & 0xf) > 9)) btmp -= 6; if ((af_.b.l&CF) | (af_.b.h > 0x99)) btmp -= 0x60; }
           else { if ((af_.b.l&HF) | ((af_.b.h & 0xf) > 9)) btmp += 6; if ((af_.b.l&CF) | (af_.b.h > 0x99)) btmp += 0x60; }q_ = (af_.b.l&(CF | NF)) | (af_.b.h > 0x99) | ((af_.b.h^btmp)&HF) | Szp[btmp]; af_.b.l = q_; af_.b.h = btmp; NEXT_INSTR; break;   // DAA
...
case 0x33: if (t_ == 6) { ++sp_; NEXT_INSTR; }
           else { ++t_; } break;                                                  // INC SP
...
case 0x76: if (sig_->nmi_) { SET_NMI; }
           else if (sig_->int_ && iff1_) { SET_INT; }
           else { --pc_; SET_NOINT; }t_ = 1; SYNC_Z80; break;
...
case 0xC5: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = bc_.b.h; read_count_ = 0; }
           else { ++t_; }break; // PUSH BC
case 0xC6: machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = pc_; current_data_ = 0; read_count_ = 0; break;     // ADD A, n
case 0xC7: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 00
case 0xC8: if (t_ == 5) { TST(ZF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break; // RET Z
case 0xC9:
...
case 0xCF: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 08
case 0xD0: if (t_ == 5) { TSTN(CF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break;// RET CF
...
case 0xD5: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = de_.b.h; read_count_ = 0; }
           else { ++t_; }break;   // PUSH DE
...
case 0xD8: if (t_ == 5) { TST(CF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break; // RET C
...
case 0xDF: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 18
case 0xE0: if (t_ == 5) { TSTN(PF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break;// RET PO
...
case 0xE5: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = hl_.b.h; read_count_ = 0; }
           else { ++t_; }break; // PUSH HL
case 0xE6: machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = pc_; current_data_ = 0; read_count_ = 0; break;  // AND n
case 0xE7: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 20
case 0xE8: if (t_ == 5) { TST(PF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break; // RET PE
...
case 0xEF: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 28
case 0xF0: if (t_ == 5) { TSTN(SF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break;// RET M
...
case 0xF5: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = af_.b.h; read_count_ = 0; }
           else { ++t_; }break; // PUSH AF
case 0xF6: machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = pc_; current_data_ = 0; read_count_ = 0; break;// OR n
case 0xF7: if (t_ == 5) { machine_cycle_ = M_MEMORY_W; t_ = 1; current_address_ = --sp_; current_data_ = pc_ >> 8; read_count_ = 0; }
           else { ++t_; }break; // RST 30
case 0xF8: if (t_ == 5) { TST(SF) { machine_cycle_ = M_MEMORY_R; t_ = 1; current_address_ = sp_++; current_data_ = 0; read_count_ = 0; } else { NEXT_INSTR } }
           else { ++t_; }break; // RET P
case 0xF9: if (t_ == 6) { sp_ = hl_.w; NEXT_INSTR; }
           else { ++t_; }break;// LD SP, HL
