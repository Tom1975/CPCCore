...
#define FILL_CB_FUNC_GEN(str_asm, base, func)\
   ...
   FillStructOpcode<ED>(0x42, &Z80::DefaultFetch, 1, "SBC HL, BC");
   FillStructOpcode<ED>(0x43, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD (%nn__), BC");
   FillStructOpcode<ED>(0x44, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x45, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x46, &Z80::DefaultFetch, 1, "IM 0");
   FillStructOpcode<ED>(0x47, &Z80::DefaultFetch, 1, "LD I, A");
   ...
   FillStructOpcode<ED>(0x4A, &Z80::DefaultFetch, 1, "ADC HL, BC");
   FillStructOpcode<ED>(0x4B, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD BC, (%nn__)");
   FillStructOpcode<ED>(0x4C, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x4D, &Z80::DefaultFetch, 1, "RETI");
   FillStructOpcode<ED>(0x4E, &Z80::DefaultFetch, 1, "IM 0");
   FillStructOpcode<ED>(0x4F, &Z80::DefaultFetch, 1, "LD R, A");
   ...
   FillStructOpcode<ED>(0x52, &Z80::DefaultFetch, 1, "SBC HL, DE");
   FillStructOpcode<ED>(0x53, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD (%nn__), DE");
   FillStructOpcode<ED>(0x54, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x55, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x56, &Z80::DefaultFetch, 1, "IM 1");
   FillStructOpcode<ED>(0x57, &Z80::DefaultFetch, 1, "LD A, I");
   ...
   FillStructOpcode<ED>(0x5A, &Z80::DefaultFetch, 1, "ADC HL, DE");
   FillStructOpcode<ED>(0x5B, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD DE, (%nn__)");
   FillStructOpcode<ED>(0x5C, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x5D, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x5E, &Z80::DefaultFetch, 1, "IM2");
   FillStructOpcode<ED>(0x5F, &Z80::DefaultFetch, 1, "LD A, R");
   ...
   FillStructOpcode<ED>(0x62, &Z80::DefaultFetch, 1, "SBC HL, HL");
   FillStructOpcode<ED>(0x63, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LN (%nn__), HL");
   FillStructOpcode<ED>(0x64, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x65, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x66, &Z80::DefaultFetch, 1, "IM 0");
   FillStructOpcode<ED>(0x67, &Z80::DefaultFetch, 1, "RRD");
   ...
   FillStructOpcode<ED>(0x6A, &Z80::DefaultFetch, 1, "ADC HL, HL");
   FillStructOpcode<ED>(0x6B, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LN HL, (%nn__)");
   FillStructOpcode<ED>(0x6C, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x6D, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x6E, &Z80::DefaultFetch, 1, "IM 0");
   FillStructOpcode<ED>(0x6F, &Z80::DefaultFetch, 1, "RLD");
   ...
   FillStructOpcode<ED>(0x72, &Z80::DefaultFetch, 1, "SBC HL, SP");
   FillStructOpcode<ED>(0x73, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD (%nn__), SP");
   FillStructOpcode<ED>(0x74, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x75, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x76, &Z80::DefaultFetch, 1, "IM 1");
   FillStructOpcode<ED>(0x77, &Z80::DefaultFetch, 1, "NOP");
   ...
   FillStructOpcode<ED>(0x7A, &Z80::DefaultFetch, 1, "ADC HL, SP");
   FillStructOpcode<ED>(0x7B, &Z80::Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>, 3, "LD SP, (%nn__)");
   FillStructOpcode<ED>(0x7C, &Z80::DefaultFetch, 1, "NEG");
   FillStructOpcode<ED>(0x7D, &Z80::DefaultFetch, 1, "RETN");
   FillStructOpcode<ED>(0x7E, &Z80::DefaultFetch, 1, "IM 2");
   FillStructOpcode<ED>(0x7F, &Z80::DefaultFetch, 1, "NOP");
   FillStructOpcode<ED>(0xA0, &Z80::DefaultFetch, 1, "LDI");
   FillStructOpcode<ED>(0xA1, &Z80::DefaultFetch, 1, "CPI");
   FillStructOpcode<ED>(0xA2, &Z80::DefaultFetch, 1, "INI");
   FillStructOpcode<ED>(0xA3, &Z80::DefaultFetch, 1, "OUTI");
   FillStructOpcode<ED>(0xA8, &Z80::DefaultFetch, 1, "LDD");
   FillStructOpcode<ED>(0xA9, &Z80::DefaultFetch, 1, "CPD");
   FillStructOpcode<ED>(0xAA, &Z80::DefaultFetch, 1, "IND");
   FillStructOpcode<ED>(0xAB, &Z80::DefaultFetch, 1, "OUTD");
   FillStructOpcode<ED>(0xB0, &Z80::DefaultFetch, 1, "LDIR");
   FillStructOpcode<ED>(0xB1, &Z80::DefaultFetch, 1, "CPIR");
   FillStructOpcode<ED>(0xB2, &Z80::DefaultFetch, 1, "INIR");
   FillStructOpcode<ED>(0xB3, &Z80::DefaultFetch, 1, "OTIR");
   FillStructOpcode<ED>(0xB8, &Z80::DefaultFetch, 1, "LDDR");
   FillStructOpcode<ED>(0xB9, &Z80::DefaultFetch, 1, "CPDR");
   FillStructOpcode<ED>(0xBA, &Z80::DefaultFetch, 1, "INDR");
   FillStructOpcode<ED>(0xBB, &Z80::DefaultFetch, 1, "OTDR");
   FillStructOpcode<ED>(0xED, &Z80::DefaultFetch, 1, "%ED");
