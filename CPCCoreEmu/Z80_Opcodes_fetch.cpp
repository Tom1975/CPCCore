...
#define FILL_CB_FUNC_GEN(str_asm, base, func)\
   ...
   FillStructOpcode<DD>(0x46, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD B, (IX+%n)");
   FillStructOpcode<DD>(0x4C, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_C, R_IXh>*/, 2, "LD C, IXh");
   FillStructOpcode<DD>(0x4D, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_C, R_IXl>*/, 2, "LD C, IXl");
   FillStructOpcode<DD>(0x4E, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD C, (IX+%n)");
   FillStructOpcode<DD>(0x54, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_D, R_IXh>*/, 2, "LD D, IXh");
   FillStructOpcode<DD>(0x55, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_D, R_IXl>*/, 2, "LD D, IXl");
   FillStructOpcode<DD>(0x56, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD D, (IX+%n)");
   FillStructOpcode<DD>(0x5C, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_E, R_IXh>*/, 2, "LD E, IXh");
   FillStructOpcode<DD>(0x5D, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_E, R_IXl>*/, 2, "LD E, IXl");
   FillStructOpcode<DD>(0x5E, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD E, (IX+%n)");
   FillStructOpcode<DD>(0x60, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_B>*/, 2, "LD IXh, B");
   FillStructOpcode<DD>(0x61, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_C>*/, 2, "LD IXh, C");
   FillStructOpcode<DD>(0x62, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_D>*/, 2, "LD IXh, D");
   FillStructOpcode<DD>(0x63, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_E>*/, 2, "LD IXh, E");
   FillStructOpcode<DD>(0x64, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_IXh>*/, 2, "LD IXh, IXh");
   FillStructOpcode<DD>(0x65, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_IXl>*/, 2, "LD IXh, IXl");
   FillStructOpcode<DD>(0x66, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD H, (IX+%n)");
   FillStructOpcode<DD>(0x67, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXh, R_A>*/, 2, "LD IXh, A");
   FillStructOpcode<DD>(0x68, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_B>*/, 2, "LD IXl, B");
   FillStructOpcode<DD>(0x69, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_C>*/, 2, "LD IXl, C");
   FillStructOpcode<DD>(0x6A, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_D>*/, 2, "LD IXl, D");
   FillStructOpcode<DD>(0x6B, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_E>*/, 2, "LD IXl, E");
   FillStructOpcode<DD>(0x6C, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_IXh>*/, 2, "LD IXl, IXh");
   FillStructOpcode<DD>(0x6D, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_IXl>*/, 2, "LD IXl, IXl");
   FillStructOpcode<DD>(0x6E, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD L, (IX+%n)");
   FillStructOpcode<DD>(0x6F, &Z80::DefaultFetch/*Opcode_Ld_Reg<R_IXl, R_A>*/, 2, "LD IXl, A");

   FillStructOpcode<DD>(0x70, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), B");
   FillStructOpcode<DD>(0x71, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), C");
   FillStructOpcode<DD>(0x72, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), D");
   FillStructOpcode<DD>(0x73, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), E");
   FillStructOpcode<DD>(0x74, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), H");
   FillStructOpcode<DD>(0x75, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), L");
   FillStructOpcode<DD>(0x77, &Z80::DefaultFetch/*Opcode_Read_REGW<M_MEMORY_R, ADDR_PC>*/, 2, "LD (IX+%n), A");
